<footer>
							...
							<div class="row row-cols">
								...
								<div class="col-md-4 col-links hidden-xs">
									...
									<ul class="list-unstyled">
										...
										<li><a href="#"><i class="fa fa-angle-right"></i>Serviços</a></li>
										<li><a href="#"><i class="fa fa-angle-right"></i>Contato</a></li>
									</ul>
								...
								<div class="col-md-4 col-get-in-touch">
									...
									<address class="hidden-xs">
										<i class="fa fa-map-marker"></i> Em breve</span>
									</address>

									<p class="hidden-xs"><a href="tel:(34) 98809-9556"><i class="fa fa-phone"></i>(34) 98809-9556</a></p>
			...
			<div class="row row-cinza-escuro">
				...
				<div class="container copyright-mobile">
					...
					<p class="pull-left">Copyright © BferreiraCode. All rights reserved.</p>
					<p class="pull-right text-roxo">Created by BferreiraCode Soluções Empresariais</p>
